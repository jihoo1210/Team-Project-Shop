...
export const fetchItems = (params: ItemListQuery) =>
  axiosClient.get<PaginatedResponse<ItemSummary>>('/item', { params }).then((res) => res.data)
...
export const createItem = (data: CreateOrUpdateItemRequest) =>
  axiosClient.post<{ item_id: string }>('/admin/item', data).then((res) => res.data)
...
export const fetchFavoriteItems = (params?: PageableQuery) =>
  axiosClient.get<PaginatedResponse<ItemSummary>>('/item/favorite', { params }).then((res) => res.data)
...
export const fetchCartItems = (params?: PageableQuery) =>
  axiosClient.get<PaginatedResponse<ItemSummary>>('/item/cart', { params }).then((res) => res.data)
